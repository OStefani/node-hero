...
function Req() {
    ...
    /** All the events listeners functions are stores in the _events property in 
     * the db object. Every Req which is created stores the event listener function 
     * in the object, hence to avoid the memory leaks we should to remove the handler 
     * if it exists. */
    this.end = function () {
...
setInterval(function() {
    ...
    /**The heap is where objects, strings, and closures are stored. Variables are stored 
     * in the stack and the actual JavaScript code resides in the code segment.**/
